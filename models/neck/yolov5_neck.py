...
from ..backbone.common import Conv, Concat, C3, RFAConv
...
class YoloV5Neck(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.C1 = C3(int(self.input_p5 / 2) + self.input_p4, self.input_p4, self.get_depth(3), False, 1, 0.5,
                     C_ACT)  # 13
        ...
        self.C4 = C3(self.output_p4 + int(self.input_p5 / 2), self.output_p5, self.get_depth(3), False, 1, 0.5,
                     C_ACT)  # 23
