...
class YoloV5RfaBackBone(nn.Module):
    def __init__(self,cfg):
        super(YoloV5RfaBackBone, self).__init__()
        ...
        self.stage2_2 = C3_RFAConv(self.channels_out['stage2_1'], self.channels_out['stage2_2'], self.get_depth(3), True, 1,0.5)
...
#rfa_conv
    def forward(self, x):
        ...
        sppf = self.sppf(x5)
        # self.save_tensor_to_csv(c3, r'D:\efficientteacher-main\models\backbone\tensor_1.csv')
        # self.save_tensor_to_csv(c4, r'D:\efficientteacher-main\models\backbone\tensor_2.csv')
        # self.save_tensor_to_csv(sppf, r'D:\efficientteacher-main\models\backbone\tensor_3.csv')
    ...
    def save_tensor_to_csv(self, tensor, file_name):
        ...
        # 展平为 [channels * height, width] 的2D数组
