...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r"D:\efficientteacher-main\runs\175-220-1024\rfa-self1150-875-et2\exp16\weights\best.pt", help='model path(s)')
    parser.add_argument('--source', type=str, default=r"G:\wkkSet\henanSet\images\2016_29.png", help='file/dir/URL/glob, 0 for webcam')
