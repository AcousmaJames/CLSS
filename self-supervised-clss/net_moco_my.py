...
# from efficientteacher-main.models import YoloV5BackBone
# stage one ,unsupervised learning
# from models import YoloV5BackBone
from models.backbone.yolov5_backbone import YoloV5BackBone


class SimCLRStage1(nn.Module):
    def __init__(self, cfg, feature_dim=128):
        super(SimCLRStage1, self).__init__()

        # 使用自定义的YoloV5BackBone
        self.f = YoloV5BackBone(cfg)
